...
from erpnext._shims.manufacturing.doctype.bom.bom import (
	add_additional_cost,
...
class StockEntry(StockController, SubcontractingInwardController):
	...
	def validate_source_stock_entry(self):
		...
		from erpnext._shims.manufacturing.doctype.work_order.work_order import get_disassembly_available_qty
	...
	def get_backflush_based_on(self):
		from erpnext._shims.manufacturing.doctype.bom.bom import get_backflush_based_on
	...
	def get_bom_raw_materials(self, qty):
		from erpnext._shims.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_subcontracting_order_status(self):
		if self.subcontracting_order and self.purpose in ["Send to Subcontractor", "Material Transfer"]:
			from erpnext._shims.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (  # guarded
