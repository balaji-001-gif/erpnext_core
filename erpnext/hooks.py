...
doctype_list_js = {
	"Code List": [
	# [REMOVED - module not in this build] "edi/doctype/code_list/code_list_import.js",
	],
	"Common Code": [
	# [REMOVED - module not in this build] "edi/doctype/code_list/code_list_import.js",
	],
...
# [REMOVED - module not in this build] "Work Order"
calendars = ["Task", "Sales Order", "Holiday List", "ToDo"]

# [REMOVED - module not in this build] "BOM"
...
sounds = [
	# [REMOVED - module not in this build] {"name": "incoming-call", "src": "/assets/erpnext/sounds/incoming-call.mp3", "volume": 0.2},
	# [REMOVED - module not in this build] {"name": "call-disconnect", "src": "/assets/erpnext/sounds/call-disconnect.mp3", "volume": 0.2},
	# [REMOVED - module not in this build] {"name": "numpad-touch", "src": "/assets/erpnext/sounds/numpad-touch.mp3", "volume": 0.8},
]
...
has_website_permission = {
	...
	# [REMOVED - module not in this build] "Issue": "erpnext.support.doctype.issue.issue.has_website_permission",
...
doc_events = {
	"*": {
		"validate": [
	# [REMOVED - module not in this build] "erpnext.support.doctype.service_level_agreement.service_level_agreement.apply",
	...
	"Communication": {
		"on_update": [
	# [REMOVED - module not in this build] "erpnext.support.doctype.service_level_agreement.service_level_agreement.on_communication_update",
	# [REMOVED - module not in this build] "erpnext.support.doctype.issue.issue.set_first_response_time",
		],
		"after_insert": [
	# [REMOVED - module not in this build] "erpnext.crm.utils.link_communications_with_prospect",
	# [REMOVED - module not in this build] "erpnext.crm.utils.update_modified_timestamp",
		],
	},
	"Event": {
	# [REMOVED - module not in this build] "after_insert": "erpnext.crm.utils.link_events_with_prospect",
	},
	"Sales Invoice": {
		"on_submit": [
	...
	"Contact": {
	# [REMOVED - module not in this build] "on_trash": "erpnext.support.doctype.issue.issue.update_issue",
	# [REMOVED - module not in this build] "after_insert": "erpnext.telephony.doctype.call_log.call_log.link_existing_conversations",
	# [REMOVED - module not in this build] "validate": ["erpnext.crm.utils.update_lead_phone_numbers"],
	},
	"Email Unsubscribe": {
	# [REMOVED - module not in this build] "after_insert": "erpnext.crm.doctype.email_campaign.email_campaign.unsubscribe_recipient"
	},
	"Integration Request": {
...
scheduler_events = {
	"cron": {
		"0/15 * * * *": [
	# [REMOVED - module not in this build] "erpnext.manufacturing.doctype.bom_update_log.bom_update_log.resume_bom_cost_update_jobs",
		],
		"0/30 * * * *": [
	...
	"hourly": [
	# [REMOVED - module not in this build] "erpnext.projects.doctype.project.project.hourly_reminder",
	],
	"hourly_long": [],
	"hourly_maintenance": [
		"erpnext.stock.doctype.repost_item_valuation.repost_item_valuation.repost_entries",
		"erpnext.utilities.bulk_transaction.retry",
	# [REMOVED - module not in this build] "erpnext.projects.doctype.project.project.collect_project_status",
	# [REMOVED - module not in this build] "erpnext.projects.doctype.project.project.project_status_update_reminder",
	...
	"daily_long": [],
	"daily_maintenance": [
	# [REMOVED - module not in this build] "erpnext.support.doctype.issue.issue.auto_close_tickets",
	# [REMOVED - module not in this build] "erpnext.crm.doctype.opportunity.opportunity.auto_close_opportunity",
		"erpnext.controllers.accounts_controller.update_invoice_status",
		"erpnext.accounts.doctype.fiscal_year.fiscal_year.auto_create_fiscal_year",
	# [REMOVED - module not in this build] "erpnext.projects.doctype.task.task.set_tasks_as_overdue",
		"erpnext.stock.doctype.serial_no.serial_no.update_maintenance_status",
		"erpnext.buying.doctype.supplier_scorecard.supplier_scorecard.refresh_scorecards",
		"erpnext.setup.doctype.company.company.cache_companies_monthly_sales_history",
		"erpnext.assets.doctype.asset.asset.update_maintenance_status",
		"erpnext.assets.doctype.asset.asset.make_post_gl_entry",
	# [REMOVED - module not in this build] "erpnext.crm.doctype.contract.contract.update_status_for_contracts",
	# [REMOVED - module not in this build] "erpnext.projects.doctype.project.project.update_project_sales_billing",
	# [REMOVED - module not in this build] "erpnext.projects.doctype.project.project.send_project_status_email_to_users",
	# [REMOVED - module not in this build] "erpnext.quality_management.doctype.quality_review.quality_review.review",
	# [REMOVED - module not in this build] "erpnext.support.doctype.service_level_agreement.service_level_agreement.check_agreement_status",
	# [REMOVED - module not in this build] "erpnext.crm.doctype.email_campaign.email_campaign.send_email_to_leads_or_contacts",
	# [REMOVED - module not in this build] "erpnext.crm.doctype.email_campaign.email_campaign.set_email_campaign_status",
	...
	# [REMOVED - module not in this build] "erpnext.manufacturing.doctype.bom_update_tool.bom_update_tool.auto_update_latest_price_in_all_boms",
	# [REMOVED - module not in this build] "erpnext.crm.utils.open_leads_opportunities_based_on_todays_event",
...
ignore_links_on_delete = [
	...
	# [REMOVED - module not in this build] additional_timeline_content = {"*": ["erpnext.telephony.doctype.call_log.call_log.get_linked_call_logs"]}


extend_bootinfo = [
	# [REMOVED - module not in this build] "erpnext.support.doctype.service_level_agreement.service_level_agreement.add_sla_doctypes",
