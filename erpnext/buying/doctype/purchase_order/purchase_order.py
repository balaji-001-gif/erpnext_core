...
from erpnext._shims.manufacturing.doctype.blanket_order.blanket_order import (
...
from erpnext._shims.subcontracting.doctype.subcontracting_bom.subcontracting_bom import (
...
class PurchaseOrder(BuyingController):
	...
	def update_subcontracting_order_status(self):
		# Subcontracting module not present in this build
		return
